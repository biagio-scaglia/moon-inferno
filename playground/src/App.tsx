    ...
    <Container size="xl" className="app-root-container">
      ...
      <Stack gap="2.5rem" style={{ position: 'relative', zIndex: 1 }}>
        ...
        <Navbar variant="inferno" isSticky={false} className="header-nav">
          <NavbarBrand>
            <div className="header-brand">
              ...
              <Badge variant="pixel" icon={<SparklesIcon size={12} />}>v0.4.1</Badge>
            </div>
          </NavbarBrand>
        ...
        <Marquee variant="pixel" speed={22}>
          <span style={{ color: 'var(--mi-color-primary)', fontWeight: 'bold' }}>MOON-INFERNO v0.4.1 IS LIVE ON NPM &amp; CDN</span>
          <span>--</span>
